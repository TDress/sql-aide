 ...
 * sql argument names must not have whitespace,
 * or special characters
 *  
 * @param {String} name The command name.
 * @param {Object} config Configuration which includes
 *    properties `sql` (the query string) and
 *    `description` (description of command that will
 *    be used when displaying command on CLI.
